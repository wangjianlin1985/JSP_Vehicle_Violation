...
public class Dbnew extends New {
    ...
    public Dbnew(String sql) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                n.setLid(ParamUtils.getSqlString(rs.getString("lid")));
            }
    ...
    public Dbnew(HttpServletRequest request) {
        ...
        n.setLid(ParamUtils.getRequestString(request, "lid"));
    }
    ...
    public Collection Select(String sql) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                nw.setLid(ParamUtils.getSqlString(rs.getString("lid")));
                coll.add(nw);
            }
