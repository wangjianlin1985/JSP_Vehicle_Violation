...
public class HtmlUtils {
	...
	public static String table(int step, int row, int page, String http,
		...
		String str = "<table width=100% border=0 cellpadding=0 cellspacing=0 style='font-size:10pt;' class='TableTitle1'><tr align=center>";
		str += "<td width=120>共" + row + "条记录</td><td width=120>第" + npage
				+ "/" + spage + "页</td>";
		str += "<td width=160><a target='" + target + "' href='" + http
				+ "?page=" + 1 + http2+"'>|&lt;</a>&nbsp;&nbsp;<a target='" + target
				+ "' href='" + http + "?page=" + bpage + http2
				+ "'>&lt;&lt;</a>&nbsp;&nbsp;<a target='" + target + "' href='"
				+ http + "?page=" + lpage + http2
				+ "'>&gt;&gt;</a>&nbsp;&nbsp;<a target='" + target + "' href='"
				+ http + "?page=" + spage+ http2
	...
	public static String table(int row, int page, String http,String http2) {
		return table(FinalConstants.STEP, row, page, http, "_self",http2);
	}
}
