    ...
    <td><form method="post" action="user_modify.jsp" name="formr">  
            <table width="97%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableNew" style="padding-left:5px;"> 
              ...
              <tr style="padding:5px;"> 
                <td width="94" height="27" bgcolor="#FFFFFF">用户类型</td> 
                <td width="420" bgcolor="#FFFFFF">
				<input name="status" type="radio" class="noborder" value="0" checked> 
				     普通会员
                  <input name="status" type="radio" class="noborder" value="3"> 
                	车辆违章后台管理员</td> 
                <td width="258" rowspan="14" valign="top" bgcolor="#FFFFFF" class="Redfont">
				注意： 
              ...
              <tr bgcolor="#FFFFFF"> 
                <td height="27">性别</td> 
                <td><input name="sex" type="radio" class="noborder" value="1"> 
                  男
