...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableNew">
  <tr align="center">
    <td colspan="3" class="TableTitle1" >添加维修信息</td>
  </tr>
  <form action="wx_modify.jsp" method="post" name="forms">
    <tr align="center">
      <td width="23%" bgcolor="#FFFFFF">维修</td>
      <td width="37%" align="left" bgcolor="#FFFFFF"> <input name="name" type="text"> </td>
    </tr>
    <tr align="center">
      <td width="23%" bgcolor="#FFFFFF">维修号</td>
