...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableNew">
  <tr align="center">
    <td colspan="8" class="TableTitle1" >驾驶员信息管理</td>
  </tr>
  <tr align="center">
    <td colspan="7" bgcolor="#FFFFFF">　</td>
    <td bgcolor="#FFFFFF"><a href="jsy_add.jsp" target="_self" >添加新驾驶员信息</a></td>
  </tr>
  <tr align="center">
...
%> 
  <tr align="center">
    <td height="27" colspan="5" bgcolor="#FFFFFF">当前驾驶员信息为空</td>
  </tr>   
  <%
     }else{
  ...
  <tr align="center">
    ...
    <td bgcolor="#FFFFFF"><a href="jsy_update.jsp?action=modify&id=<%=a.getId()%>"><img src="../images/modify.gif" border="0"></a>&nbsp;&nbsp; 
    <a href="jsy_modify.jsp?action=del&id=<%=a.getId()%>" onClick="javascript:return confirm('你确定删除吗？')"><img src="../images/del.gif" border="0"></a>
    </td>
  </tr>
  <%
   }
%>
  <tr align="right">
    <td height="27" colspan="8" class="TableTitle1" ><%=HtmlUtils.table(bf.getRow("jsy"),submit_page,"jsy_list.jsp","")%></td>
  </tr>
  <%
}
%>
