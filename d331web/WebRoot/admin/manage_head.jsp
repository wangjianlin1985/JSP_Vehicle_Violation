...
<%@ page import="com.core.*" %><%if (Crazyadept.UserIsOK(session,FinalConstants.STATUS_USER)) return;%>
<html>
<head>
...
<table width="98%"  border="0" cellpadding="0" cellspacing="1" class="tableNew"> 
  ...
  <tr align="center"> 
    <td colspan="4" class="TableTitle1" ><%=HtmlUtils.table(bf.getRow("ico WHERE state="+FinalConstants.STATE_HEAD),submit_page,"manage_head.jsp","")%></td> 
  </tr> 
</table> 
</body>
</html>
