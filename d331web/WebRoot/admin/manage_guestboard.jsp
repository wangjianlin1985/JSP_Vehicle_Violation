...
Collection coll=bf.ListGuestboard(submit_page,"ORDER BY gid");if(coll==null||coll.size()<=0){%> 
  <tr align="center"> 
    <td height="27" colspan="3" bgcolor="#FFFFFF">当前讨论薄为空</td> 
  </tr> 
  ...
  <tr align="left"> 
    ...
    <td height="27" align="center" bgcolor="#FFFFFF"><a href="modify_guestboard.jsp?action=del&gid=<%=a.getGid()%>" onClick="javascript:return confirm('你确定删除该条讨论吗？')">删除</a></td> 
  </tr>  <%}}%> 
  <tr align="right"> 
    <td height="27" colspan="3" class="TableTitle1" ><%=HtmlUtils.table(bf.getRow("guestboard ORDER BY gid"),submit_page,"manage_guestboard.jsp","")%></td> 
  </tr> 
</table> 
</body>
</html>
