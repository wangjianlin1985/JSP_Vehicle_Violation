...
if (Crazyadept.UserIsOK(session,FinalConstants.STATUS_USER)) {    out.println("<script>parent.location.href='../index.jsp';</script>");
    return ;}%>
<html>
<head>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableNew"> 
  ...
  <tr align="right"> 
    <td height="27" colspan="4" class="TableTitle1" ><%=HtmlUtils.table(bf.getRow("affiche"),submit_page,"manage_affiche.jsp","")%></td> 
  </tr>   <%}%> 
</table> 
</body>
</html>
