...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableNew">
  <tr align="center">
    <td colspan="8" class="TableTitle1" >车辆报废信息管理</td>
  </tr>
  <tr align="center">
    <td colspan="7" bgcolor="#FFFFFF">　</td>
    <td bgcolor="#FFFFFF"><a href="clbf_add.jsp" target="_self" >添加新车辆报废信息</a></td>
  </tr>
  <tr align="center">
    <td height="27" bgcolor="#FFFFFF">车辆信息</td>
    <td bgcolor="#FFFFFF">车辆报废名称</td>
    <td bgcolor="#FFFFFF">车辆报废号</td>
    <td bgcolor="#FFFFFF">有效期</td>
    <td bgcolor="#FFFFFF">类型</td>
    <td bgcolor="#FFFFFF">时间</td>
    <td bgcolor="#FFFFFF">车辆报废原因</td>
...
<%
  ...
  //out.print(idS);
  String sql="";
  if(id!=null){ sql="SELECT * FROM clbf where id='"+id+"' order by id";}
  else{ sql="SELECT * FROM clbf order by id";  }
        ...
        try {
            ...
            System.out.println(ps + " Clbf select ");
                if (ps != null) {
                    ps.close();
                    ps = null;
                }
...
%> 
  <tr align="center">
    <td height="27" colspan="5" bgcolor="#FFFFFF">当前车辆报废信息为空</td>
  </tr>   
  <%
     }else{
  ...
  <tr align="center">
    ...
    <td bgcolor="#FFFFFF"><a href="clbf_update.jsp?action=modify&id=<%=a.getId()%>"><img src="../images/modify.gif" border="0"></a>&nbsp;&nbsp; 
    <a href="clbf_modify.jsp?action=del&id=<%=a.getId()%>" onClick="javascript:return confirm('你确定删除吗？')"><img src="../images/del.gif" border="0"></a>
    </td>
  </tr>
  <%
   }
%>
  <tr align="right">
    <td height="27" colspan="8" class="TableTitle1" ><%=HtmlUtils.table(bf.getRow("clbf"),submit_page,"clbf_list.jsp","")%></td>
  </tr>
  <%
}
%>
