...
function news(){
	if(form2.title.value==""){
		alert("新闻信息标题不允许为空");	return false;
	}
	if(form2.content.value==""){
		alert("请填写新闻信息内容");	return false;
	}
}
function linkss(){
	if(form2.name.value==""){
...
function mend(){
	...
	if(forms.sid.value==""){
		alert("请选择车辆信息");	return false;
	}
	if(forms.name.value==""){
		alert("请填写课程名称");	return false;
	}
	if(forms.filesize.value==""){
		alert("请填写附件大小");	return false;
	}
	if(forms.resume.value==""){
		alert("请填写课程简介");	return false;
	}
}
function logons(){
	if(forms.uid.value==""){
